...
% % {A Hybrid FPGA-ASIC Delayed Feedback Reservoir System to Enable Spectrum Sensing/Sharing for Low Power IoT Devices} % Job title
% % {2021 IEEE/ACM International Conference On Computer Aided Design (ICCAD)} % Organization
