...
%\definecolor{awesome}{HTML}{006633} % Uncomment if you would like to specify your own color
...
\name{}{Osaze Y. Shears}
\address{890 Hollybush Rd., Elberon, Virginia, 23846}
\mobile{(757) 508-2757}

\email{oshears@vt.edu}
%\homepage{oshears.github.io}
\github{oshears}
\linkedin{linkedin.com/in/osazeshears}
%\skype{skypeid}
...
\position{Computer Hardware Engineer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

%\makecvfooter{\today}{Osaze Y. Shears~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
